...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'renarso':
				// Renarso ANIMATION LOADING CODE
				frames = FlxAtlasFrames.fromSparrow('assets/images/renarso.png', 'assets/images/renarso.xml');
				animation.addByPrefix('idle', 'Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'Sing Note UP', 24, false);
				animation.addByPrefix('singRIGHT', 'Sing Note RIGHT', 24, false);
				animation.addByPrefix('singDOWN', 'Sing Note DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'Sing Note LEFT', 24, false);
			...
			case 'renarsocrazy':
				// Renarso ANIMATION LOADING CODE
				frames = FlxAtlasFrames.fromSparrow('assets/images/renarsocrazy.png', 'assets/images/renarsocrazy.xml');
				animation.addByPrefix('idle', 'Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'Sing Note UP', 24, false);
				animation.addByPrefix('singRIGHT', 'Sing Note RIGHT', 24, false);
				animation.addByPrefix('singDOWN', 'Sing Note DOWN', 24, false);
			...
			case 'renarsoevil':
				// RenarsoEvil ANIMATION LOADING CODE
				frames = FlxAtlasFrames.fromSparrow('assets/images/renarsoevil.png', 'assets/images/renarsoevil.xml');
				animation.addByPrefix('idle', 'Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'Sing Note UP', 24, false);
				animation.addByPrefix('singRIGHT', 'Sing Note RIGHT', 24, false);
				animation.addByPrefix('singDOWN', 'Sing Note DOWN', 24, false);
			...
			case 'gf-outside':
				// GIRLFRIEND CODE
				frames = FlxAtlasFrames.fromSparrow('assets/images/gf-outside.png', 'assets/images/gf-outside.xml');

				animation.addByPrefix('danceLeft', 'Idle DanceL', 12, false);
				animation.addByPrefix('danceRight', 'Idle DanceR', 12, false);
			...
			case 'bf-demongf':
				frames = FlxAtlasFrames.fromSparrow('assets/images/bf-demongf.png', 'assets/images/bf-demongf.xml');
				animation.addByPrefix('idle', 'Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'Sing Note UP', 24, false);
				animation.addByPrefix('singLEFT', 'Sing Note LEFT', 24, false);
				animation.addByPrefix('singRIGHT', 'Sing Note RIGHT', 24, false);
				animation.addByPrefix('singDOWN', 'Sing Note DOWN', 24, false);
				animation.addByPrefix('singUPmiss', 'Miss Note UP', 24, false);
				animation.addByPrefix('singLEFTmiss', 'Miss Note LEFT', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'Miss Note RIGHT', 24, false);
				animation.addByPrefix('singDOWNmiss', 'Miss Note DOWN', 24, false);

				addOffset('idle', -5);
				addOffset("singUP", -5, -5);
				addOffset("singRIGHT", -25, -2);
				addOffset("singLEFT", -8, -4);
				addOffset("singDOWN", 19, 14);
				addOffset("singUPmiss", -14, -14);
				addOffset("singRIGHTmiss", 10, -7);
				addOffset("singLEFTmiss", -38, -5);
				addOffset("singDOWNmiss", 18, 4);
				playAnim('idle');
	...
	private var outdanced:Bool = false;
