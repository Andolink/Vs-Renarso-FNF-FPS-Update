...
class PlayState extends MusicBeatState
{
	...
	public static var outsideSongs:Array<String>;
	public static var outsidecrazySongs:Array<String>;
	public static var outsideevilSongs:Array<String>;
	...
	var ghost0:FlxSprite;
	var ghost1:FlxSprite;
	var ghost2:FlxSprite;
	var ghost3:FlxSprite;
	var ghost4:FlxSprite;
	var ghost5:FlxSprite;
	var GhostDance:Bool = false;

	private var enemyShake:Bool = false;
	...
	override public function create()
	{
		...
		outsideSongs = ["fan"];
		outsidecrazySongs = ["crazy"];
		outsideevilSongs = ["corrupt"];
		...
		else if (evilSchoolSongs.contains(SONG.song.toLowerCase()))
		{
			 ...
			 */
		...
		else if (outsideSongs.contains(SONG.song.toLowerCase()))
				  {
						defaultCamZoom = 0.9;
						curStage = 'outside';

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/6.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						...
						var stageCity:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/5.png');
						stageCity.setGraphicSize(Std.int(stageCity.width * 1.1));
						stageCity.updateHitbox();
						stageCity.antialiasing = true;
						stageCity.scrollFactor.set(0.4, 0.4);
						stageCity.active = false;
						add(stageCity);
	
						var stageHill:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/4.png');
						stageHill.setGraphicSize(Std.int(stageHill.width * 1.1));
						stageHill.updateHitbox();
						stageHill.antialiasing = true;
						stageHill.scrollFactor.set(0.55, 0.55);
						stageHill.active = false;
						add(stageHill);

						var stageWood:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/3.png');
						stageWood.setGraphicSize(Std.int(stageWood.width * 1.1));
						stageWood.updateHitbox();
						stageWood.antialiasing = true;
						stageWood.scrollFactor.set(0.6, 0.6);
						stageWood.active = false;
						add(stageWood);
	
						var stageGrass1:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/2.png');
						stageGrass1.setGraphicSize(Std.int(stageGrass1.width * 1.1));
						stageGrass1.updateHitbox();
						stageGrass1.antialiasing = true;
						stageGrass1.scrollFactor.set(0.85, 0.85);
						stageGrass1.active = false;
						add(stageGrass1);
	
						var stageGrass0:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/1.png');
						stageGrass0.setGraphicSize(Std.int(stageGrass0.width * 1.1));
						stageGrass0.updateHitbox();
						stageGrass0.antialiasing = true;
						stageGrass0.scrollFactor.set(0.92, 0.92);
						stageGrass0.active = false;
						add(stageGrass0);

						var stageTree:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outside/0.png');
						stageTree.setGraphicSize(Std.int(stageTree.width * 1.1));
						stageTree.updateHitbox();
						stageTree.antialiasing = true;
						stageTree.scrollFactor.set(0.95, 0.95);
						stageTree.active = false;
						add(stageTree);
				  }
			
				  else if (outsidecrazySongs.contains(SONG.song.toLowerCase()))
			  	  {
						defaultCamZoom = 0.9;
						curStage = 'outsideCrazy';

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/6.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(0, 0);
						...
						var stageCity:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/5.png');
						stageCity.setGraphicSize(Std.int(stageCity.width * 1.1));
						stageCity.updateHitbox();
						stageCity.antialiasing = true;
						stageCity.scrollFactor.set(0.4, 0.4);
						...
						var stageHill:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/4.png');
						stageHill.setGraphicSize(Std.int(stageHill.width * 1.1));
						stageHill.updateHitbox();
						stageHill.antialiasing = true;
						stageHill.scrollFactor.set(0.55, 0.55);
						...
						var stageWood:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/3.png');
						stageWood.setGraphicSize(Std.int(stageWood.width * 1.1));
						stageWood.updateHitbox();
						stageWood.antialiasing = true;
						stageWood.scrollFactor.set(0.6, 0.6);
						...
						var stageGrass1:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/2.png');
						stageGrass1.setGraphicSize(Std.int(stageGrass1.width * 1.1));
						stageGrass1.updateHitbox();
						stageGrass1.antialiasing = true;
						stageGrass1.scrollFactor.set(0.85, 0.85);
						...
						var stageGrass0:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/1.png');
						stageGrass0.setGraphicSize(Std.int(stageGrass0.width * 1.1));
						stageGrass0.updateHitbox();
						stageGrass0.antialiasing = true;
						stageGrass0.scrollFactor.set(0.92, 0.92);
						...
						var stageTree:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideCrazy/0.png');
						stageTree.setGraphicSize(Std.int(stageTree.width * 1.1));
						stageTree.updateHitbox();
						stageTree.antialiasing = true;
						stageTree.scrollFactor.set(0.95, 0.95);
				  ...
				  else if (outsideevilSongs.contains(SONG.song.toLowerCase()))
				  {
						defaultCamZoom = 0.9;
						curStage = 'outsideEvil';

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/9__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(0, 0);
						...
						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/8__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						...
						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/7__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(0.2, 0.2);
						stageBack.active = false;
						add(stageBack);

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/6__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(0.3, 0.3);
						stageBack.active = false;
						add(stageBack);

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/5__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						...
						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/4__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(0.7, 0.7);
						stageBack.active = false;
						add(stageBack);

						ghost0 = new FlxSprite(0, 0);
		                ghost0.frames = FlxAtlasFrames.fromSparrow('assets/images/outsideEvil/ghost.png', 'assets/images/outsideEvil/ghost.xml');
						ghost0.animation.addByPrefix('Idle DanceL', "Idle DanceL", 24, false);
						ghost0.animation.addByPrefix('Idle DanceR', "Idle DanceR", 24, false);
		                ghost0.antialiasing = true;
		                ghost0.scrollFactor.set(0.8, 0.8);
		                ghost0.setGraphicSize(Std.int(ghost0.width * 0.85));
						ghost0.screenCenter();
						ghost0.x = ghost0.x;
		                ghost0.updateHitbox();
		                add(ghost0);

						ghost1 = new FlxSprite(0, 0);
		                ghost1.frames = FlxAtlasFrames.fromSparrow('assets/images/outsideEvil/ghost.png', 'assets/images/outsideEvil/ghost.xml');
						ghost1.animation.addByPrefix('Idle DanceL', "Idle DanceL", 24, false);
						ghost1.animation.addByPrefix('Idle DanceR', "Idle DanceR", 24, false);
		                ghost1.antialiasing = true;
		                ghost1.scrollFactor.set(0.8, 0.8);
		                ghost1.setGraphicSize(Std.int(ghost1.width * 0.85));
						ghost1.screenCenter();
						ghost1.x = ghost1.x-300;
		                ghost1.updateHitbox();
		                add(ghost1);

						ghost2 = new FlxSprite(0, 0);
		                ghost2.frames = FlxAtlasFrames.fromSparrow('assets/images/outsideEvil/ghost.png', 'assets/images/outsideEvil/ghost.xml');
						ghost2.animation.addByPrefix('Idle DanceL', "Idle DanceL", 24, false);
						ghost2.animation.addByPrefix('Idle DanceR', "Idle DanceR", 24, false);
		                ghost2.antialiasing = true;
		                ghost2.scrollFactor.set(0.8, 0.8);
		                ghost2.setGraphicSize(Std.int(ghost2.width * 0.85));
						ghost2.screenCenter();
						ghost2.x = ghost2.x+300;
						ghost2.y = ghost2.y+30;
		                ghost2.updateHitbox();
		                add(ghost2);

						ghost3 = new FlxSprite(0, 0);
		                ghost3.frames = FlxAtlasFrames.fromSparrow('assets/images/outsideEvil/ghost.png', 'assets/images/outsideEvil/ghost.xml');
						ghost3.animation.addByPrefix('Idle DanceL', "Idle DanceL", 24, false);
						ghost3.animation.addByPrefix('Idle DanceR', "Idle DanceR", 24, false);
		                ghost3.antialiasing = true;
		                ghost3.scrollFactor.set(0.8, 0.8);
		                ghost3.setGraphicSize(Std.int(ghost3.width * 0.85));
						ghost3.screenCenter();
						ghost3.x = ghost3.x-600;
						ghost3.y = ghost3.y+30;
		                ghost3.updateHitbox();
		                add(ghost3);

						ghost4 = new FlxSprite(0, 0);
		                ghost4.frames = FlxAtlasFrames.fromSparrow('assets/images/outsideEvil/ghost.png', 'assets/images/outsideEvil/ghost.xml');
						ghost4.animation.addByPrefix('Idle DanceL', "Idle DanceL", 24, false);
						ghost4.animation.addByPrefix('Idle DanceR', "Idle DanceR", 24, false);
		                ghost4.antialiasing = true;
		                ghost4.scrollFactor.set(0.8, 0.8);
		                ghost4.setGraphicSize(Std.int(ghost4.width * 0.85));
						ghost4.screenCenter();
						ghost4.x = ghost4.x+600;
						ghost4.y = ghost4.y+80;
		                ghost4.updateHitbox();
		                add(ghost4);

						ghost5 = new FlxSprite(0, 0);
		                ghost5.frames = FlxAtlasFrames.fromSparrow('assets/images/outsideEvil/ghost.png', 'assets/images/outsideEvil/ghost.xml');
						ghost5.animation.addByPrefix('Idle DanceL', "Idle DanceL", 24, false);
						ghost5.animation.addByPrefix('Idle DanceR', "Idle DanceR", 24, false);
		                ghost5.antialiasing = true;
		                ghost5.scrollFactor.set(0.8, 0.8);
		                ghost5.setGraphicSize(Std.int(ghost5.width * 0.85));
						ghost5.screenCenter();
						ghost5.x = ghost5.x+900;
						ghost5.y = ghost5.y+80;
		                ghost5.updateHitbox();
		                add(ghost5);

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/3__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(0.88, 0.88);
						stageBack.active = false;
						add(stageBack);

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/2__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(1.05, 1.05);
						stageBack.active = false;
						add(stageBack);

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/1__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(1.1, 1.1);
						stageBack.active = false;
						add(stageBack);

						var stageBack:FlxSprite = new FlxSprite(-250, -200).loadGraphic('assets/images/outsideEvil/0__.png');
						stageBack.setGraphicSize(Std.int(stageBack.width * 1.1));
						stageBack.updateHitbox();
						stageBack.antialiasing = true;
						stageBack.scrollFactor.set(1.15, 1.15);
						stageBack.active = false;
						add(stageBack);
				  }
		...
		switch (curStage)
		{
			...
			case 'schoolEvil':
				gfVersion = 'gf-pixel';
			case 'outside' | 'outsideCrazy' | 'outsideEvil' :
				gfVersion = 'gf-outside';
		}
	...
	function endSong():Void
	{
		...
		if (isStoryMode)
		{
			...
			else
			{
				...
				{
					case 'fan':
						FlxG.switchState(new VideoState('assets/videos/cutscene1.webm', function(){
							FlxG.switchState(new PlayState());
						}));
					case 'crazy':
						FlxG.switchState(new VideoState('assets/videos/cutscene2.webm', function(){
							FlxG.switchState(new PlayState());
						}));
					default:
						FlxG.switchState(new PlayState());
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			case 'outsideEvil':
				...
				if (GhostDance)
				{
					ghost0.animation.play('Idle DanceL', true);
					ghost1.animation.play('Idle DanceL', true);
					ghost2.animation.play('Idle DanceL', true);
					ghost3.animation.play('Idle DanceL', true);
					ghost4.animation.play('Idle DanceL', true);
					ghost5.animation.play('Idle DanceL', true);
				}
				else
				{		
					ghost0.animation.play('Idle DanceR', true);
					ghost1.animation.play('Idle DanceR', true);
					ghost2.animation.play('Idle DanceR', true);
					ghost3.animation.play('Idle DanceR', true);
					ghost4.animation.play('Idle DanceR', true);
					ghost5.animation.play('Idle DanceR', true);
				}
